...
test.each([
  ['before.json', 'after.json', 'tree', 'resultSet.txt'],
  ['before.yml', 'after.yml', 'tree', 'resultSet.txt'],
  ['before.ini', 'after.ini', 'tree', 'resultSet.txt'],
  ['beforeTree.yml', 'afterTree.yml', 'tree', 'resultTree.txt'],
  ['beforeTree.ini', 'afterTree.ini', 'tree', 'resultTree.txt'],
